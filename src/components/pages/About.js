function About() {
    ...
    return(
        <div className="about">
            ...
            <p className="about-p1"><br></br>Welcome to the wonderful world of StudyParty streaming site. Where we curate the best of the best music made by music lovers and just for you! In StudyParty, we offer direct links to Study Music and Party Music for your mood and taste for your liking. So come along and discover your next hit song for your everyday needs.</p>
            <p>Created and Curated By Ryan See and Keith Ma</p>
